...
namespace SnakeBattleNet.Core.Battlemanager
{
    public class BattleManager
    {
        ...
        public void Fight(BattleField battleField, IList<Fighter> fighters, int rounds)
        {
            if (fighters.Count > battleField.Gateways.Count)
        ...
        /// </summary>
        private void InitializeField(BattleField battleField, IList<Fighter> fighters)
        {
        ...
        /// </summary>
        private void Act(BattleField battleField, IEnumerable<Fighter> fighters)
        {
        ...
        private void TryToBite(BattleField battleField, Fighter snakeBiter, IEnumerable<Fighter> fighters, Move newHeadPosition)
        {
            foreach (var snake in fighters)
            {
        ...
        private void SnakeIsMoving(BattleField battleField, Fighter fighter, Move newHeadPosition)
        {
            CutTail(battleField, fighter);
            MoveHead(battleField, fighter, newHeadPosition);
        }

        private void SnakeIsbitting(BattleField battleField, Fighter snakeBitter, Fighter snakeBitten)
        {
        ...
        private void SnakeIsGrowing(BattleField battleField, Fighter snake, Move newHeadPosition)
        {
            MoveHead(battleField, snake, newHeadPosition);
        }

        private void MoveHead(BattleField battleField, Fighter snake, Move newHeadPosition)
        {
            if (snake.Length != 0)
            {
        ...
        private void CutTail(BattleField battleField, Fighter fighter)
        {
