...
namespace SnakeBattleNet.Test.Core.FighterTests
{
    ...
    internal class When_call_CutTail_and_length_3
    {
        Establish context = () =>
        {
        ...
        It should_make_fighter_with_head = () =>
            fighter.Head.ShouldEqual(new Directed { X = 10, Y = 13, Direction = Direction.North });

        It should_make_fighter_with_one_body_segment = () =>
            fighter.Body.ShouldContainOnly(new Directed { X = 10, Y = 12, Direction = Direction.North });
