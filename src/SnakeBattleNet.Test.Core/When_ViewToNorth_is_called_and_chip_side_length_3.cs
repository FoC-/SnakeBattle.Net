...
namespace SnakeBattleNet.Test.Core
{
    ...
    internal class When_ViewToNorth_is_called_and_chip_side_length_3
    {
        Establish context = () =>
        {
        ...
        Because of = () =>
            result = battleField.ViewToNorth(new Position { X = 25, Y = 25 }, new Position { X = 1, Y = 1 }, 3);
        ...
        It should_return_wall_at_top = () =>
            result.Count(c => c.Key.Y == 2 && c.Value == Content.Wall).ShouldEqual(3);
