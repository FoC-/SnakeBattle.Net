...
namespace SnakeBattleNet.Test.Core
{
    ...
    {
        protected static Fighter CreateSnakeStub(ICollection<IEnumerable<ChipCell>> chips, BattleField battleField)
        {
        ...
        protected static IEnumerable<ChipCell> CreateChipWithAndColoredHead()
        {
